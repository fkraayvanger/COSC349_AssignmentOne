...
<center>
<table border="1">
<tr><th>Dog Names</th><th>Dog Price</th><th>Dog Age</th><th>Dog Breed</th><th>Dog Sex</th></tr>
...
while($row = $q->fetch()){
echo "<tr><td>".$row["dog_name"]."</td><td>".$row["dog_price"]."</td><td>".$row["dog_age"]."</td><td>".$row["dog_breed"]."</td><td>".$row["dog_sex"]."</td></tr>\n";
}
