...
<center><h3>Welcome to the Admin Site. This site contains additional information on the pets, and lets the admin have access to any necessary info.</h3></center>
    </div>
    <img class="image1" src="freeimage.jpg" alt="dog" width ="300" height="300">
    <div style="font-family: Tahoma, sans-serif; margin-right: 30px; margin-left: 30px; height 600px; background-color: #FFC0CB; color: #F52887">
    <center><h3> Our Company prides itself on the effort to help abandoned dogs and pups find their forever home</h3></center>
    </div>
    </body>
  </div>
  <center><h3> All images are royalty-free from: pixabay.com</h3></center>
</html>
<style>
.space {
  max-width: 500px;
