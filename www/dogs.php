...
<div style="font-family: Tahoma, sans-serif; margin-top: 20px;  margin-right: 30px; margin-left: 30px; height 600px; background-color: #FFC0CB; COLOR: #f52887">
<center><h3>We made the conscious decision to leave out the breeds and sex of the adoptees. Primarily to incentivise adopters to meet the pet beforehand.</h3></center>
</div>
</div>
</html>
<style>
